...
export default function IletisimPage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!formData.first_name || formData.first_name.length < 2) {
            if (window.Swal) {
                window.Swal.fire({
                    icon: 'error',
                    title: 'Hata!',
                    text: 'Adınız en az 2 karakter olmalıdır.',
        ...
        if (!formData.last_name || formData.last_name.length < 2) {
            if (window.Swal) {
                window.Swal.fire({
                    icon: 'error',
                    title: 'Hata!',
                    text: 'Soyadınız en az 2 karakter olmalıdır.',
                    confirmButtonColor: '#C41E3A',
                    confirmButtonText: 'Tamam'
                })
            }
        ...
        if (!formData.phone || !phonePattern.test(cleanedPhone)) {
            if (window.Swal) {
                window.Swal.fire({
                    icon: 'error',
                    title: 'Hata!',
                    text: 'Geçerli bir Türkiye telefon numarası giriniz.',
                    confirmButtonColor: '#C41E3A',
                    confirmButtonText: 'Tamam'
                })
            }
        ...
        try {
            ...
            if (response.ok && result.success) {
                if (window.Swal) {
                    window.Swal.fire({
                        icon: 'success',
                        title: 'Başarılı!',
                        text: result.message || 'Mesajınız başarıyla gönderildi.',
                        confirmButtonColor: '#C41E3A',
                        confirmButtonText: 'Tamam'
                    }).then(() => {
                        setFormData({
                ...
                throw new Error(result.message || 'Bir hata oluştu. Lütfen tekrar deneyiniz.')
            }
        } catch (error: any) {
            if (loadingElement) {
                loadingElement.style.display = 'none'
            ...
            const errorMessage = error.message || 'Bir hata oluştu. Lütfen tekrar deneyiniz.'
        ...
        <div id="contact-page">
            ...
            <div className="contact-page-header">
                <div className="container text-center">
                    <h1>Bize Ulaşın</h1>
                    <p>Herhangi bir sorunuz veya yorumunuz var mı? Sadece bize bir mesaj yazın!</p>
                </div>
            </div>
            ...
            <div className="container pb-5">
                <div className="contact-wrapper">
                    ...
                    <div className="contact-info-card">
                        ...
                        <p>Sohbet başlatmak için bir şey söyleyin!</p>
                        ...
                        <form id="contactForm" method="POST" onSubmit={handleSubmit}>
                            <div className="contact-form-row">
                                <div className="contact-form-col">
                                    <label className="form-label">Adınız <span className="required-mark">*</span></label>
                                    <input 
                                        type="text" 
                                        name="first_name" 
                                        id="first_name" 
                                ...
                                <div className="contact-form-col">
                                    <label className="form-label">Soyadınız <span className="required-mark">*</span></label>
                                    <input 
                                        type="text" 
                                        name="last_name" 
                                        id="last_name" 
                            ...
                            <div className="contact-form-row">
                                <div className="contact-form-col">
                                    <label className="form-label">E-Posta Adresiniz <span className="required-mark">*</span></label>
                                    <input 
                                        type="email" 
                                        name="email" 
                                        id="email" 
                                ...
                                <div className="contact-form-col">
                                    <label className="form-label">Telefon Numaranız <span className="required-mark">*</span></label>
                                    <input 
                                        type="tel" 
                                        name="phone" 
                                        id="phone" 
                            ...
                            <div className="contact-form-group">
                                ...
                                <div className="subject-options">
                                    <div className="subject-option">
                                        ...
                                        />
                                        <label htmlFor="subject_vize">Schengen Vize Alımı</label>
                                    </div>
                                    <div className="subject-option">
                                        <input 
                                            type="radio" 
                                            ...
                                            onChange={handleSubjectChange}
                                        />
                                        <label htmlFor="subject_basvuru">Başvuru Yapı</label>
                                    </div>
                                    <div className="subject-option">
                                        <input 
                                            type="radio" 
                                            ...
                                            onChange={handleSubjectChange}
                                        />
                                        <label htmlFor="subject_randevu">Vize Randevusu</label>
                                    </div>
                                    <div className="subject-option">
                                        <input 
                                            type="radio" 
                                            ...
                                            onChange={handleSubjectChange}
                                        />
                                        <label htmlFor="subject_hizmetler">Popüler Ülkeler</label>
                                    </div>
                                    <div className="subject-option">
                                        <input 
                                            type="radio" 
                                            ...
                                            onChange={handleSubjectChange}
                                        />
                                        <label htmlFor="subject_diger">Diğer</label>
                                    </div>
                                </div>
                            </div>

                            <div className="contact-form-group">
                                <label className="form-label">Mesajınız <span className="required-mark">*</span></label>
                                <textarea 
                                    name="message" 
                                    id="message" 
                                    className="form-control" 
