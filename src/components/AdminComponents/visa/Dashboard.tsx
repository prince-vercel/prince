            ...
            {stats.topDestinations.map((dest, index) => (
              <div key={index} className={styles.operationItem}>
                <div className={styles.operationInfo}>
                  <span className={styles.operationRank} style={{ color: '#c42127' }}>#{index + 1}</span>
                ...
                <div className={styles.operationBar}>
                  <div
                    ...
                    style={{
                      ...
                      background: 'linear-gradient(90deg, #f0dbdc, #c42127)'
                    }}
                  />
                </div>
                <span className={styles.operationCount} style={{ color: '#c42127' }}>{dest.count}</span>
              </div>
            ))}
          </div>
        )}
