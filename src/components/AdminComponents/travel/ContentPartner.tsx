...
const ContentPartner = () => {
  ...
  const loadPartners = async () => {
    try {
      const querySnapshot = await getDocs(collection(db, getCollectionName('travelcontents/partner/partners', selectedLanguage)))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addDoc(collection(db, getCollectionName('travelcontents/partner/partners', selectedLanguage)), {
  ...
  const handleDelete = async (partnerId: string) => {
    ...
    try {
      await deleteDoc(doc(db, getCollectionName('travelcontents/partner/partners', selectedLanguage), partnerId))
