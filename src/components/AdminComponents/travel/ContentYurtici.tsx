            ...
            <div className={styles.tourFormRow}>
              <div className={styles.tourFormGroup}>
                ...
                <input
                  ...
                  placeholder="Havayolu adını girin"
                />
              </div>

              <div className={styles.tourFormGroup}>
                <label>Havayolu Logosu</label>
                <div className={styles.tourImageUploadBox}>
                  {formData.airlineLogoUrl ? (
                    <div className={styles.tourImagePreview}>
                      <img src={formData.airlineLogoUrl} alt="Havayolu Logosu" style={{ maxWidth: '100px', maxHeight: '50px', objectFit: 'contain' }} />
                      <button
                        type="button"
                        onClick={() => setFormData(prev => ({ ...prev, airlineLogoUrl: '' }))}
                        className={styles.tourImageRemoveBtn}
                        title="Logoyu Kaldır"
                      >
                        ✕
                    ...
                    <label className={styles.tourImageUploadLabel}>
                      <MdImage size={32} />
                      <p>{uploadingImage ? 'Yükleniyor...' : 'Havayolu logosu seçmek için tıklayın'}</p>
                      <input
                        type="file"
                        accept="image/*"
                        onChange={handleAirlineLogoUpload}
                        disabled={uploadingImage}
                        className={styles.tourImageInput}
                      />
                    </label>
